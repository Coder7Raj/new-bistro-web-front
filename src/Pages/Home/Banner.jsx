...
export default function Banner() {
  return (
    <>
      <Carousel>
        <div>
          <img className="h-full w-full object-cover" src={banner1} />
        </div>
        <div>
        ...
        <div>
          <img className="h-full w-full object-cover" src={banner4} />
        </div>
        <div>
          <img className="h-full w-full object-cover" src={banner5} />
        </div>
        <div>
          <img className="h-full w-full object-cover" src={banner6} />
        </div>
      </Carousel>
    </>
  );
